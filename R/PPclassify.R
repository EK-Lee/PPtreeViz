...
#' test <- tot[-train]
#' Tree.result <- LDA.Tree.viz(iris[train,5],iris[train,1:4])
#' PP.classify.viz(iris[test,1:4],iris[test,5],Tree.result,1)
PP.classify.viz <- function(test.data, true.class=NULL, Tree.result, Rule, ...) {
